...
public class EntityTFBossTearFX extends EntityFX {
    ...
    public EntityTFBossTearFX(World par1World, double par2, double par4, double par6, double par8, double par10,
            double par12, Item par14Item) {
    ...
    public void onUpdate() {
        ...
        if (this.onGround && rand.nextBoolean()) {
            ...
            // this.worldObj.playAuxSFXAtEntity((EntityPlayer)null, 2002, (int)this.posX, (int)this.posY,
            // (int)this.posZ, 4037);
            ...
            for (int var1 = 0; var1 < 50; ++var1) {
                ...
                worldObj.spawnParticle(
                        ...
                        this.posX + rand.nextFloat() - rand.nextFloat(),
                        this.posY + 0.5F,
                        this.posZ + rand.nextFloat(),
                        gaussX,
                        gaussY,
                        gaussZ);
            }
