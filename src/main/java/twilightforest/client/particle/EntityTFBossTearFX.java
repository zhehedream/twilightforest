    ...
    public void onUpdate() {
        ...
        if (this.onGround && rand.nextBoolean()) {
            ...
            for (int var1 = 0; var1 < 50; ++var1) {
                ...
                worldObj.spawnParticle("iconcrack_" + Item.getIdFromItem(popItem), this.posX + rand.nextFloat() - rand.nextFloat(), this.posY + 0.5F, this.posZ + rand.nextFloat(), gaussX, gaussY,
                        gaussZ);
            }
            this.setDead();
        }
