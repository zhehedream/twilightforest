...
public class RenderTFTowerGhast extends RenderTFMiniGhast {
    ...
    protected void preRenderGhast(EntityGhast par1EntityGhast, float par2) {
        float scaleVariable = ((float) par1EntityGhast.prevAttackCounter
                + (float) (par1EntityGhast.attackCounter - par1EntityGhast.prevAttackCounter) * par2) / 20.0F;
        ...
        scaleVariable = 1.0F
                / (scaleVariable * scaleVariable * scaleVariable * scaleVariable * scaleVariable * 2.0F + 1.0F);
