...
public class TFCreatures {
    ...
    public static void registerTFCreature(Class<? extends Entity> entityClass, String entityName, int id, int backgroundEggColour, int foregroundEggColour, int trackingRange, int updateFrequency,
    ...
    /**
     * Create a new instance of an entity in the world by using an entity ID. This is the version that
     * creates twilight forest creatures for use by their spawn eggs.
     */
    ...
    /**
     * Return a string suitable for setting as the mobID in spawners. If the compatibility flag is set,
     * then use the base monster name If the flag is false, return TwilightForest.mobName
     */
