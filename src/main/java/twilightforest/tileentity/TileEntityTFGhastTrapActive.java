    ...
    public void updateEntity() {
        ...
        if (worldObj.isRemote) {
            ...
            if (counter > 100 && counter % 4 == 0) {
                TwilightForestMod.proxy.spawnParticle(this.worldObj, "hugesmoke", this.xCoord + 0.5, this.yCoord + 0.95, this.zCoord + 0.5, Math.cos(counter / 10.0) * 0.05, 0.25D,
        ...
        if (!worldObj.isRemote) {
            ...
            AxisAlignedBB aabb = AxisAlignedBB
                    .getBoundingBox((double) this.xCoord, (double) this.yCoord + 16, (double) this.zCoord, (double) (this.xCoord + 1), (double) (this.yCoord + 16 + 1), (double) (this.zCoord + 1))
                    .expand(6D, 16D, 6D);
