    ...
    public void updateEntity() {
        ...
        if (worldObj.isRemote) {
            ...
            if (counter < 30) {
                worldObj.playSound(
                        ...
                        this.yCoord + 1.5D,
                        this.zCoord + 0.5D,
                        TwilightForestMod.ID + ":mob.urghast.trapwarmup",
                        1.0F,
                        4.0F,
                        false);
            } else if (counter < 80) {
                worldObj.playSound(
                        ...
                        this.yCoord + 1.5D,
                        this.zCoord + 0.5D,
                        TwilightForestMod.ID + ":mob.urghast.trapon",
                        1.0F,
                        4.0F,
                        false);
            } else {
                worldObj.playSound(
                        ...
                        this.yCoord + 1.5D,
                        this.zCoord + 0.5D,
                        TwilightForestMod.ID + ":mob.urghast.trapspindown",
                        1.0F,
                        4.0F,
                        false);
            }
        ...
        if (!worldObj.isRemote) {
            ...
            AxisAlignedBB aabb = AxisAlignedBB.getBoundingBox(
                    ...
                    (double) (this.yCoord + 16 + 1),
                    (double) (this.zCoord + 1)).expand(6D, 16D, 6D);
