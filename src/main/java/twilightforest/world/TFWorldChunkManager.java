...
public class TFWorldChunkManager extends WorldChunkManager {
    ...
    /**
     * Returns biomes to use for the blocks and loads the other data like temperature and humidity onto
     * the WorldChunkManager Args: oldBiomeList, x, z, width, depth
     */
