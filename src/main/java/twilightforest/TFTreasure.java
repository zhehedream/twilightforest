...
public class TFTreasure {
    ...
    /**
     * Gets a common item. If the useless list is not empty, there is a 1/4 chance we get a useless item
     * instead.
     */
    ...
    /**
     * Gets a rare item. If there are items on the ultrarare list, there is a 1/4 chance we get a
     * ultrarare item instead.
     */
    ...
    /**
     * Fills the table with items for the specified type. This should be refactored into seperate
     * functions someday.
     */
