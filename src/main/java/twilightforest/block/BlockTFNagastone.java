...
//    }
     ...
     * block metadata
     * 
     * 0 - 3 head directions 4 - 7 bend down 8 - 11 bend up 12 straight n/s 13 straight e/w 14 straight
     * u/d 15 weird middle piece
     */
    @Override
...
//    	if (true || neighborID == this) { // this seems to be lies
    ...
    /**
     * Return a direction only if it is the only possible connection, otherwise return -1. This only
     * returns n/s/e/w
     */
