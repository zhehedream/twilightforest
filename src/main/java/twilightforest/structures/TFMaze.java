...
public class TFMaze {
    ...
    /**
     * Carves a block into the world. TODO: check what's there? maybe only certain blocks?
     */
    ...
    protected void putCanopyTree(World world, int x, int y, int z, StructureTFComponent component,
        ...
        // only place it if we're actually generating the chunk the tree is in (or at least the middle of
        // the tree)
