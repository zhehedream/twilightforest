...
public class ComponentTFDarkTowerMain extends ComponentTFDarkTowerWing {
    ...
    public void buildComponent(StructureComponent parent, List<StructureComponent> list, Random rand) {
        ...
        if (!this.placedKeys && this.getComponentType() < 2) {
            ...
            // System.out.println("I found " + smallTowers + " of my small towers total, with index " +
    ...
    private void placeItemFrameRotated(World world, int x, int y, int z, int rotation, int direction,
        ...
        if (sbb.isVecInside(dx, dy, dz)) {
            ...
            // check if the frame is on a valid surface or not? The wall may not have been generated yet, on a
            // chunk boundry
