...
public class TwilightForestMod {
    ...
    private void loadConfiguration(Configuration configFile) {
        ...
        configFile.get(Configuration.CATEGORY_GENERAL, "AllowPortalsInOtherDimensions",
        ...
        configFile.get(Configuration.CATEGORY_GENERAL, "AdminOnlyPortals",
        ...
        configFile.get(Configuration.CATEGORY_GENERAL, "DisablePortalCreation",
        ...
        configFile.get(Configuration.CATEGORY_GENERAL, "DisableUncrafting",
        ...
        configFile.get("Performance", "TwilightOakChance",
    ...
    /**
     * Change what dimension ID the Twilight Forest is. This is called when we connect to a server that
     * has a different dimensionID set.
     */
