...
public class TFCommonProxy implements IGuiHandler {
    ...
    /**
     * Called during the pre-load step. Register stuff here. Obviously most stuff in the common category
    ...
    /**
     * Called during the load step. Register stuff here. Obviously most stuff in the common category
     * will be just registered in the mod file
     */
